...
//微软翻译API token 有效期是10分钟，所以没9分钟重新获取一次token
setInterval(
	getToken
, 9*60*1000);
	...
	request({
			...
			if (!error && response.statusCode == 200) {
				...
				callback(txt);
	  			...
	  			console.log("[translation.js - translate]err:"+error);
	  		}
		}
	);
}
...
Translation.prototype.translateToZh = function(txt, callback) {
	if( access_token != null && access_token != "" ) {
		...
		getToken(function() {
			Translation.prototype.translate(txt, "en", "zh", callback);
		});
	}
}

Translation.prototype.translateToEn = function() {
